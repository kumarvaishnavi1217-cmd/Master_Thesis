...
class TrainEnv(gym.Env):
    ...
    def reward_function(self, done):
        ...
        ''' 3. Energy - Per Step Reward '''
        self.r_energy = 1.0 - k * (self.E / E_max)
        ...
        if done:
            ...
            elif self.reason_for_quit == 'TooFar':                                                                                                      # wenn maximale Parktoleranz nach hinten überschritten
                self.r_parking = (0.5)*(((-0.08)*self.train.speed) - 8)                                                                                 # negativer reward hoch um diesen Fall stark zu bestrafen und verlauf in Abhängigkeit von speed
